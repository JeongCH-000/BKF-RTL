"""Bit-accurate signed Q8.F arithmetic shared by vector generation and reports."""
...
from nominal_config import CONSTANTS, WIDTH, FRAC, SCALE, FX_MIN, FX_MAX


ONE = SCALE
Q_DIAG = CONSTANTS["Q_DIAG"]
R_DIAG = CONSTANTS["R_DIAG"]
ALPHA = CONSTANTS["ALPHA"]
DIAG_FLOOR = CONSTANTS["DIAG_FLOOR"]  # real 2^-10 at every format
DET_FLOOR = CONSTANTS["DET_FLOOR"]
RSQRT_ADDR_BITS = 12
