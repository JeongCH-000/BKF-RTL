...
module tb_rbkf_full #(
    ...
    wire [9*W-1:0] debug_reduced_cov_flat;
    ...
    reg [3*W-1:0] threshold_mem [0:STEPS-1];
    reg [OBS_WIDTH-1:0] bits_mem [0:STEPS-1];
    reg [3*W-1:0] reduced_observation_mem [0:STEPS-1];
    reg [9*W-1:0] cov_predict_mem [0:STEPS-1];
    reg [9*W-1:0] reduced_cov_mem [0:STEPS-1];
