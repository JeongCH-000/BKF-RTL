...
module tb_bkf_handshake;
    ...
    reg [9*W-1:0] f_vector [0:499];
    reg [3*W-1:0] expected_threshold [0:499];
    reg [2:0] expected_observation [0:499];
    reg [3*W-1:0] expected_state [0:499];
    reg [9*W-1:0] expected_cov [0:499];
    reg [3*W-1:0] held_threshold;
