...
module ekf_core (
    ...
    input wire [9*`FX_Q8_16_WIDTH-1:0] f_input_flat, input wire [3*`FX_Q8_16_WIDTH-1:0] measurement_flat,
...
`ifdef WAVE_DEBUG
    ...
    output wire [9*`FX_Q8_16_WIDTH-1:0] debug_innovation_cov_flat,
    output wire [9*`FX_Q8_16_WIDTH-1:0] debug_gain_flat,
    output wire [3*`FX_Q8_16_WIDTH-1:0] debug_innovation_flat,
    output wire signed [`FX_Q8_16_WIDTH-1:0] debug_determinant
`endif
);
    wire threshold_valid_unused;
    wire [3*`FX_Q8_16_WIDTH-1:0] threshold_unused;
    wire measurement_ready;
    wire [47:0] branch_sum_unused;
    wire [9*`FX_Q8_16_WIDTH-1:0] debug_cov_predict_int;
    wire [9*`FX_Q8_16_WIDTH-1:0] debug_innovation_cov_int;
    wire [9*`FX_Q8_16_WIDTH-1:0] debug_gain_int;
    wire [3*`FX_Q8_16_WIDTH-1:0] debug_innovation_int;
