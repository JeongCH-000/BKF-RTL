...
module bkf_l1_core (
    ...
    wire [9*`FX_Q8_16_WIDTH-1:0] unused_sign_cov;
    wire [9*`FX_Q8_16_WIDTH-1:0] unused_gain;
    wire signed [`FX_Q8_16_WIDTH-1:0] unused_determinant;
    wire [3*`FX_Q8_16_WIDTH-1:0] unused_reduced_observation;
