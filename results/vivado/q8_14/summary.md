...
| --- | --: | --: | --: | --: | --: | --: | --: | --: |
| BKF L=1 | 4894 | 4371 | 8.5 | 1 | 0.167 | 0.130 | 4.500 | 0.151 |

2026-09-11에 저장된 `results_bit-width/results_Q8_14/`의 여섯 text report를 [bkf_l1/](bkf_l1/)에 정리함. Report design은 `bkf_l1_core`이며 EKF/rBKF 결과는 포함하지 않음. 이번 저장소 업데이트에서 Vivado를 다시 실행하지 않았음.
